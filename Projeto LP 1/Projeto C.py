while True:
    ...
    nome_produto = str(input("Digite o nome do produto (Digite 'sair' para finalizar): "))
    ...
    #verificando se o produto deu lucro ou prejuízo
    if receita > custo_produto:
        print(f"O lucro foi de R${lucro:.2f}")
    else:
        print(f"O prejuízo foi de R${abs(lucro):.2f}")
